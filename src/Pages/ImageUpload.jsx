...
import { baseUrl, ImageUploadServer } from "../api/apiCall.js";
import toast, { Toaster } from "react-hot-toast";
import { BarLoader } from "react-spinners";

const ImageUpload = () => {
  const [images, setImages] = useState(["https://via.placeholder.com/350", "https://via.placeholder.com/350", "https://via.placeholder.com/350"]);
  ...
  return (
    <>
      ...
      <div className="px-4 py-6 sm:px-8 sm:py-8 bg-[#ffe7b0] lg:px-32 lg:py-12 overflow-scroll hide-scrollbar mt-10">
